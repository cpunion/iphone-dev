...
#else
#error Add the correct JBLEN size for your target here!
#endif
...
/* APPLE LOCAL end radar 4491211 */
	 ...
	 unchanged (it already has a struct return type).  */
      if (
/* iphone-dev local: This is for the ARM, which has a struct_value_rtx()
 * function that lies (it actually DOES reserve a hidden first argument, 
 * although it says it doesn't) and confuses this module without this ifdef. */
#ifndef BROKEN_STRUCT_VALUE_RTX 
        !targetm.calls.struct_value_rtx (0, 0) &&
#endif
        (TREE_CODE (ret_type) == RECORD_TYPE
